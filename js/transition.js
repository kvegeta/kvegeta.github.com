$(document).ready(function() {
  $("#button a").click(function(e) {
    $(this).parents("section").find(".pulsante").addClass("animationout").removeClass("animationin");
  ...
  $("#xbutton").click(function(e) {
    ...
    $("#button").parents("section").find(".pulsante").removeClass("animationout").addClass("animationin");
